...
复制scrapy shell http://doc.scrapy.org/en/latest/_static/selectors-sample1.html
...
复制>>> result = response.selector.xpath('//a')
>>> result
...
复制>>> response.xpath('//a/text()').extract()
...
复制>>> response.xpath('//a[@href="image1.html"]/text()').extract()
['Name: My image 1 ']
...
复制>>> response.xpath('//a[@href="image1.html"]/text()').extract_first()
'Name: My image 1 '
...
复制>>> response.xpath('//a[@href="image1"]/text()').extract_first()>>> response.xpath('//a[@href="image1"]/text()').extract_first('Default Image')
'Default Image'
...
复制>>> response.css('a[href="image1.html"]').extract()
['<a href="image1.html">Name: My image 1 <br><img src="image1_thumb.jpg"></a>']
...
复制>>> response.css('a[href="image1.html"] img').extract_first()
'<img src="image1_thumb.jpg">'
接下来的两个用法不太一样。节点的内部文本和属性的获取是这样实现的，如下所示：

复制>>> response.css('a[href="image1.html"]::text').extract_first()
'Name: My image 1 '
...
复制>>> response.xpath('//a').css('img').xpath('@src').extract()
